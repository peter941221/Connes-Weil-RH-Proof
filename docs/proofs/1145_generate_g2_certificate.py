...
def grounding_a():
    ...
    return (module_scaffold("C1ConcreteClassMomentGroundingA",
                            ["import ConnesWeilRH.Dev.C1ConcreteClassMomentBase"],
                            doc)
            + "section GroundingLayersA\n" + "".join(body) + "end GroundingLayersA\n"
            + MODULE_END.format(ns="C1ConcreteClassMomentGroundingA"))
...
def grounding_c():
    ...
    return (module_scaffold("C1ConcreteClassMomentGroundingC",
                            ["import ConnesWeilRH.Dev.C1ConcreteClassMomentBase",
                             "import ConnesWeilRH.Dev.C1ConcreteClassMomentGroundingB"],
                            doc)
            + OPT_BLOCK + "\n"
            + per_index_theorems() + prefix_machinery()
            + MODULE_END.format(ns="C1ConcreteClassMomentGroundingC"))
