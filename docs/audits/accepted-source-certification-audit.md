...
| `docs/audits/accepted-source-packet-completion-audit.md` | records packet coverage for every source-facing row and keeps certification open until external or formal acceptance |
| `docs/audits/ccm24-source-interface-accepted-source-packet.md` | starts the CCM24 source-interface packet for fixed-S model, support/window, bounded comparison, and Sonin comparison |
| `docs/audits/ccm25-source-interface-accepted-source-packet.md` | starts the CCM25 source-interface packet for `QW`, `Psi`, `QW_lambda`, finite-prime atoms, pole normalization, and no-spectral boundary |
| `docs/audits/cc20-trace-source-interface-accepted-source-packet.md` | starts the CC20 trace packet for support-square trace, trace-class legality, cyclicity, Mellin convention, and local signs |
| `01_TOP_DOWN_TRACE_SCALE_SOURCE_TERM_LEDGER.md` | starts the first S2-B1 accepted-source packet by mapping possible trace-scale source terms to `QW_lambda`, rank, pole, or endpoint-strip `Cdef` |
...
| CCM24 source-interface packet | `ccm24-source-interface-accepted-source-packet.md` | Does a reviewer accept the fixed-S model, support/window, bounded comparison, and Sonin comparison used by the route? |
| CCM25 source-interface packet | `ccm25-source-interface-accepted-source-packet.md` | Does a reviewer accept `QW`, `Psi`, `QW_lambda`, finite-prime atoms, pole normalization, and the no-spectral boundary? |
| CC20 trace source-interface packet | `cc20-trace-source-interface-accepted-source-packet.md` | Does a reviewer accept trace legality, cyclicity, support-square trace, Mellin convention, and local signs? |
| S2-B1 trace-scale source-term ledger | `01_TOP_DOWN_TRACE_SCALE_SOURCE_TERM_LEDGER.md` | Does every source-owned scalar in the positive-trace read-off land in `QW_lambda`, rank, pole, or endpoint-strip `Cdef`, with no untracked divergent bulk or hidden finite-part subtraction? |
