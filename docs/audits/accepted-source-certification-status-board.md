...
Lean status: theorem-base source-model discharge complete for rows 1-3
```
...
| Lean theorem-base target implemented | Lean has a data-bearing theorem-base target and clean constructor audit, but the analytic row is not discharged |
| Lean theorem-base field partially discharged | Lean has discharged one named theorem-base field from a source model; the row is not fully discharged |
| Lean theorem-base fields discharged | Lean has theorem-base fields projected from explicit source-model laws with clean axiom audit; accepted-source and downstream route packages may still remain open |
...
|---:|---|---|---|---|
| 1 | `docs/audits/ccm24-source-interface-accepted-source-packet.md` | CCM24 fixed-S model, support/window, bounded comparison, Sonin comparison | Lean theorem-base fields discharged | Goal 2 may consume `CCM24TheoremBase.discharged`; source-object equalities still remain |
| 2 | `docs/audits/ccm25-source-interface-accepted-source-packet.md` | CCM25 `QW`, `Psi`, `QW_lambda`, finite-prime atoms, pole normalization, no-spectral boundary | Lean theorem-base fields discharged | Goal 2 may consume `CCM25TheoremBase.discharged`; restricted-to-full and final-sign packets still remain |
| 3 | `docs/audits/cc20-trace-source-interface-accepted-source-packet.md` | CC20 trace legality, support-square trace, cyclicity, Mellin convention, local signs | Lean theorem-base fields discharged | Goal 2 may consume `CC20TheoremBase.dischargedTraceBase`; CC20 RH exit remains Goal 5 |
| 4 | `01_TOP_DOWN_TRACE_SCALE_SOURCE_TERM_LEDGER.md` | S2-B1 trace-scale no-missing-bulk theorem | decision record opened | complete `docs/audits/s2-b1-trace-scale-referee-decision-record.md` after rows 1-3 or with the same reviewer |
...
| Did this pass touch Lean? | yes, rows 1-3 now have source-model theorem-base fields and audited constructors |
