...
| evidence | role |
|---|---|
| `docs/audits/trace-scale-source-term-ledger.md` | primary term ledger |
...
|---|---|---|
| exact theorem statement matches S2-B1 | `trace-scale-source-term-ledger.md`, "Theorem Candidate" | pending |
| exact hypotheses are present and sufficient | source-interface packets for CCM24, CCM25, and CC20 | pending |
| source anchors support the trace and restricted Weil objects | `trace-scale-source-term-ledger.md`, "Source Anchors" | pending |
