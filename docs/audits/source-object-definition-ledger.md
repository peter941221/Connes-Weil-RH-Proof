...
| `globalPrimeIndexSet` | full source prime-power support for the finite-prime part of `Psi` | `mc2arXiv.tex:445-470`; `ConnesWeilRH/Basic.lean:46,78-80`; `docs/proofs/ccm25-qw-psi-definition-sign-discharge.md` | `SourceGlobalPrimeIndexCoverage` | a hidden empty or underspecified finite-prime index set can erase terms |
...
| `poleFunctional` and `polePairing` | the CCM25 pole functional and restricted pole pairing | `mc2arXiv.tex:465-470,533-535`; `ConnesWeilRH/Basic.lean:51-52,103-105`; `docs/proofs/ccm25-qw-psi-definition-sign-discharge.md` | `SourcePoleNormalization` | triple vanishing can kill a route pole while the source pole channel remains |
