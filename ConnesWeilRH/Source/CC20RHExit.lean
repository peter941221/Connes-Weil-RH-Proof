...
def tripleVanishingSymbols
    {B : RHDefinitionBridge}
    (h : SourceFiniteVanishingCriterionPackage B) :
    TripleVanishingSymbols where
  vanishesAt p :=
    p ∈ h.finiteVanishingSet ∧
      ¬B.sourceNontrivialZero (criticalVanishingPointValue p)

theorem triple_vanishing_zero_of_source_package
    {B : RHDefinitionBridge}
    (h : SourceFiniteVanishingCriterionPackage B) :
    h.tripleVanishingSymbols.vanishesAt CriticalVanishingPoint.zero :=
  ⟨h.zero_mem_of_source_package_finite_set,
    zero_not_source_nontrivial_zero_of_source_package h⟩

theorem triple_vanishing_half_of_source_package
    {B : RHDefinitionBridge}
    (h : SourceFiniteVanishingCriterionPackage B) :
    h.tripleVanishingSymbols.vanishesAt CriticalVanishingPoint.half :=
  ⟨h.half_mem_of_source_package_finite_set,
    half_not_source_nontrivial_zero_of_source_package h⟩

theorem triple_vanishing_one_of_source_package
    {B : RHDefinitionBridge}
    (h : SourceFiniteVanishingCriterionPackage B) :
    h.tripleVanishingSymbols.vanishesAt CriticalVanishingPoint.one :=
  ⟨h.one_mem_of_source_package_finite_set,
    one_not_source_nontrivial_zero_of_source_package h⟩

theorem triple_vanishing_statement_of_source_package
    {B : RHDefinitionBridge}
    (h : SourceFiniteVanishingCriterionPackage B) :
    TripleVanishingSymbols.TripleVanishingStatement
      h.tripleVanishingSymbols := by
  intro p
  cases p with
  | zero => exact triple_vanishing_zero_of_source_package h
  | half => exact triple_vanishing_half_of_source_package h
  | one => exact triple_vanishing_one_of_source_package h
