...
This is a genuine quantitative reverse theorem, not a uniformity claim.  A
uniform transition bound is therefore exposed as an explicit additional
producer contract.  No such bound, Gate 3U estimate, finite-S sign, Burnol
identity, or RH premise is asserted here.
-/
