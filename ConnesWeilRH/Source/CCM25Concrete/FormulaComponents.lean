      ...
      W.archimedeanTerm (W.convolutionStar f f) +
        W.polePairing f -
          PrimePowerArithmetic.MathlibRestrictedFinitePrimeEvaluatorSumOnIndexSet
            W f f lambda h.restricted.finitePrimeSumReadOff.scopedArithmeticData :=
...
theorem psi_source_evaluations_of_formula_components
    {W : WeilFormSymbols} {f : TestFunction} {lambda : ℝ}
    (h : ConcreteCCM25FormulaComponents W f lambda) :
    W.psi (W.convolutionStar f f) =
      W.poleFunctional (W.convolutionStar f f) -
        W.archimedeanTerm (W.convolutionStar f f) -
          GlobalComponent.GlobalSourceEvaluationsFinitePrimeEvaluatorSumOnIndexSet
            W f f h.global.finitePrimeSumReadOff.scopedArithmeticData :=
  GlobalComponent.psi_source_evaluations_of_component h.global

theorem psi_mathlib_pairing_sum_of_formula_components
    {W : WeilFormSymbols} {f : TestFunction} {lambda : ℝ}
    (h : ConcreteCCM25FormulaComponents W f lambda) :
    W.psi (W.convolutionStar f f) =
      W.poleFunctional (W.convolutionStar f f) -
  ...
  GlobalComponent.psi_mathlib_pairing_sum_of_component h.global

theorem qw_source_evaluations_of_formula_components
    {W : WeilFormSymbols} {f : TestFunction} {lambda : ℝ}
    (h : ConcreteCCM25FormulaComponents W f lambda) :
    W.qw f f =
      W.poleFunctional (W.convolutionStar f f) -
        W.archimedeanTerm (W.convolutionStar f f) -
          GlobalComponent.GlobalSourceEvaluationsFinitePrimeEvaluatorSumOnIndexSet
            W f f h.global.finitePrimeSumReadOff.scopedArithmeticData :=
  GlobalComponent.qw_source_evaluations_of_component h.global

theorem qw_mathlib_pairing_sum_of_formula_components
    {W : WeilFormSymbols} {f : TestFunction} {lambda : ℝ}
    (h : ConcreteCCM25FormulaComponents W f lambda) :
    W.qw f f =
      W.poleFunctional (W.convolutionStar f f) -
        W.archimedeanTerm (W.convolutionStar f f) -
          ∑ n ∈ W.globalPrimeIndexSet,
            ArithmeticFunction.vonMangoldt n * W.primePowerPairing n f f :=
  GlobalComponent.qw_mathlib_pairing_sum_of_component h.global

theorem qw_lambda_formula_source_evaluations_of_formula_components
    {W : WeilFormSymbols} {f : TestFunction} {lambda : ℝ}
    (h : ConcreteCCM25FormulaComponents W f lambda) :
    W.qwLambda lambda f f =
      W.archimedeanTerm (W.convolutionStar f f) +
        W.polePairing f -
          RestrictedComponent.RestrictedSourceEvaluationsFinitePrimeEvaluatorSumOnIndexSet
            W f lambda h.restricted.finitePrimeSumReadOff.scopedArithmeticData :=
  RestrictedComponent.qw_lambda_formula_source_evaluations_of_component
    h.restricted

theorem qw_lambda_formula_mathlib_pairing_sum_of_formula_components
    {W : WeilFormSymbols} {f : TestFunction} {lambda : ℝ}
    (h : ConcreteCCM25FormulaComponents W f lambda) :
    W.qwLambda lambda f f =
      W.archimedeanTerm (W.convolutionStar f f) +
        W.polePairing f -
          ∑ n ∈ W.restrictedPrimeIndexSet lambda,
            ArithmeticFunction.vonMangoldt n * W.primePowerPairing n f f :=
  RestrictedComponent.qw_lambda_formula_mathlib_pairing_sum_of_component
    h.restricted
