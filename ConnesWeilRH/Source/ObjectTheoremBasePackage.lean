...
/--
Selected CC20 trace-leg legality for one source trace test.

The template direction is one-way:
`hilbertSchmidtGate g -> traceClass g /\ cyclicLegal g`.  This owner therefore
stores the selected gate and derives the selected trace/cyclicity facts from
that gate.  It does not infer the Hilbert gate from trace/cyclicity.
-/
...
namespace CC20SelectedTraceLegalityData

def ofHilbertSchmidtGate
    {A : ArchimedeanTraceSymbols} {archimedeanTest : A.Test}
    (hgate : A.hilbertSchmidtGate archimedeanTest)
    (template : ArchimedeanTraceSymbols.TraceClassTemplateStatement A) :
    CC20SelectedTraceLegalityData A archimedeanTest where
  selectedHilbertSchmidtGate := hgate
  selectedTraceClass := (template archimedeanTest hgate).1
  selectedCyclicLegal := (template archimedeanTest hgate).2
  selectedTraceClass_from_gate := fun template' =>
    (template' archimedeanTest hgate).1
  selectedCyclicLegal_from_gate := fun template' =>
    (template' archimedeanTest hgate).2

end CC20SelectedTraceLegalityData
...
/--
Selected CC20 trace read-off for the fixed source trace test.

The `positiveTrace_eq_qwLambda` field is derived from the ordinary
positive/support-square read-off and the source-owned support-square/`QW_lambda`
read-off data for the same tuple.
-/
...
namespace CC20SelectedTraceReadOffData

def ofSupportSquareQWLambda
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    {lambda : ℝ} {archimedeanTest : A.Test} {weilTest : TestFunction}
    (legality : CC20SelectedTraceLegalityData A archimedeanTest)
    (positiveTrace_eq_supportSquare :
    ...
    (supportSquare_qwLambda :
      S2B1FixedTupleSupportSquareQWLambdaReadOffSourceData
        A W lambda archimedeanTest weilTest) :
    CC20SelectedTraceReadOffData A W lambda archimedeanTest weilTest where
  legality := legality
  positiveTrace_eq_supportSquare := positiveTrace_eq_supportSquare
  supportSquare_qwLambda := supportSquare_qwLambda
  positiveTrace_eq_qwLambda :=
    positiveTrace_eq_supportSquare.trans
      (supportSquare_qwLambda.cc20SupportSquareTraceReadOff.trans
        supportSquare_qwLambda.ccm25QWLambdaSourceReadOff)

end CC20SelectedTraceReadOffData
...
def restrictedCCM25CutoffMatchesScopedFormulaAt
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols} (lambda : ℝ)
    (_archimedeanTest : A.Test) (weilTest : TestFunction)
    (pkg :
      CCM25Concrete.Package.ConcreteCCM25ArithmeticPackage
        W weilTest lambda) : Prop :=
  W.qwLambda lambda weilTest weilTest =
...
theorem sourceNoDefectMainTermEqualsScopedRestrictedFormulaAt_of_qwLambda
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    {lambda : ℝ} {archimedeanTest : A.Test} {weilTest : TestFunction}
    (pkg :
      CCM25Concrete.Package.ConcreteCCM25ArithmeticPackage
        W weilTest lambda)
    (sourceNoDefectQWLambda :
      sourceNoDefectMainTermEqualsQWLambdaAt (W := W)
        lambda archimedeanTest weilTest) :
    sourceNoDefectMainTermEqualsScopedRestrictedFormulaAt (W := W)
      lambda archimedeanTest weilTest pkg :=
  sourceNoDefectQWLambda.trans
...
theorem restrictedCCM25CutoffMatchesScopedFormulaAtHolds
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    {lambda : ℝ} {archimedeanTest : A.Test} {weilTest : TestFunction}
    (pkg :
      CCM25Concrete.Package.ConcreteCCM25ArithmeticPackage
        W weilTest lambda) :
    restrictedCCM25CutoffMatchesScopedFormulaAt
      (W := W) lambda archimedeanTest weilTest pkg :=
  CCM25Concrete.Package.qwLambda_eq_scopedRestrictedArchimedeanFormula_of_package
    pkg
...
def finitePartSourceNormalFormDataAt
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    (rows : S2B1TraceScaleTermLedgerRows A W)
    (lambda : ℝ) (hlambda : 1 < lambda)
    (archimedeanTest : A.Test) (weilTest : TestFunction) :
    S2B1FinitePartSourceNormalFormData A W lambda archimedeanTest weilTest where
  sourceScalars :=
...
def finitePartNormalFormRowsAt
  ...
  let data :=
    rows.finitePartSourceNormalFormDataAt
      lambda hlambda archimedeanTest weilTest
  { data := { scalars := data.sourceScalars.toScalarInterface }
    finitePartNormalizationFixedHolds :=
      data.finitePartNormalizationFixedHolds
...
def supportSquareMainTermEqualsScopedRestrictedFormula
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    {lambda : ℝ} {archimedeanTest : A.Test} {weilTest : TestFunction}
    (pkg :
      S2B1TraceScaleFixedTupleAnalyticExclusionPackage
    ...
    A.supportSquareTrace archimedeanTest =
      CCM25Concrete.Package.ScopedRestrictedArchimedeanFormula
        W weilTest lambda ccm25Pkg :=
  pkg.supportSquareMainTermEqualsQWLambda.trans
    (CCM25Concrete.Package.qwLambda_eq_scopedRestrictedArchimedeanFormula_of_package
      ccm25Pkg)

def sourceNoDefectMainTermEqualsScopedRestrictedFormula
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    {lambda : ℝ} {archimedeanTest : A.Test} {weilTest : TestFunction}
    (pkg :
      S2B1TraceScaleFixedTupleAnalyticExclusionPackage
    ...
    (ccm25Pkg :
      CCM25Concrete.Package.ConcreteCCM25ArithmeticPackage
        W weilTest lambda)
    (traceSquare : ArchimedeanTraceSymbols.TraceSquareStatement A)
    (htrace : A.traceClass archimedeanTest)
    (hcyclic : A.cyclicLegal archimedeanTest) :
    A.sourceNoDefectTrace archimedeanTest =
      CCM25Concrete.Package.ScopedRestrictedArchimedeanFormula
        W weilTest lambda ccm25Pkg :=
  ((traceSquare archimedeanTest htrace hcyclic).1).symm.trans
    (pkg.supportSquareMainTermEqualsScopedRestrictedFormula ccm25Pkg)
...
def finitePartSourceNormalFormDataOfGlobalPackage
    {A : ArchimedeanTraceSymbols} {W : WeilFormSymbols}
    (pkg : S2B1TraceScaleAnalyticExclusionPackage A W)
    (lambda : ℝ) (hlambda : 1 < lambda)
    (archimedeanTest : A.Test) (weilTest : TestFunction) :
...
def finitePartNormalFormRowsOfGlobalPackage
    ...
    S2B1FinitePartNormalFormRows A W lambda archimedeanTest weilTest :=
  let data :=
    finitePartSourceNormalFormDataOfGlobalPackage
...
def noHiddenFinitePartSubtractionRowOfGlobalPackage
    ...
    S2B1FixedTupleNoHiddenFinitePartSubtractionRow
      A W lambda archimedeanTest weilTest :=
  (finitePartSourceNormalFormDataOfGlobalPackage
    pkg lambda hlambda archimedeanTest weilTest).toNoHiddenFinitePartRow
...
def s2b1FixedTupleNoHiddenFinitePartSubtractionRow
  ...
  let noHidden :=
    pkg.s2b1NoHiddenFinitePartSubtractionConstructorInput
      lambda hlambda archimedeanTest weilTest
  { noHiddenFinitePartSubtractionExcluded :=
      noHidden.finitePartNormalizationFixed ∧
        noHidden.noSubtractedFinitePartTerm
    noHiddenFinitePartSubtractionExcludedHolds :=
      ⟨noHidden.finitePartNormalizationFixedHolds,
        noHidden.noSubtractedFinitePartTermHolds⟩ }
...
theorem s2b1NormalizedSeedSourceNoDefectScopedRestrictedFormula
    (pkg : SourceObjectTheoremBasePackage)
    (lambda : ℝ) (hlambda : 1 < lambda)
    (archimedeanTest :
      (CC20Concrete.TraceScale.normalizedLegalSquareTraceScaleToCC20TraceModel
    ...
    (hcyclic :
      (CC20Concrete.TraceScale.normalizedLegalSquareTraceScaleToCC20TraceModel
        pkg.s2b1NormalizedSeed).archimedeanSymbols.cyclicLegal
          archimedeanTest) :
    S2B1TraceScaleTermLedgerRows.sourceNoDefectMainTermEqualsScopedRestrictedFormulaAt
      (A :=
        (CC20Concrete.TraceScale.normalizedLegalSquareTraceScaleToCC20TraceModel
          pkg.s2b1NormalizedSeed).archimedeanSymbols)
      (W := pkg.toWeilFormSymbols)
      lambda archimedeanTest weilTest ccm25Pkg :=
  S2B1TraceScaleTermLedgerRows.sourceNoDefectMainTermEqualsScopedRestrictedFormulaAt_of_qwLambda
    ccm25Pkg
    (S2B1TraceScaleTermLedgerRows.sourceNoDefectMainTermEqualsQWLambdaAt_of_supportSquare
      (S2B1TraceScaleTermLedgerRows.supportSquareSameFiniteLambdaScalarAtHolds
...
theorem s2b1NormalizedSeedRestrictedCutoffScopedFormula
    ...
    (ccm25Pkg :
      CCM25Concrete.Package.ConcreteCCM25ArithmeticPackage
        pkg.toWeilFormSymbols weilTest lambda) :
    S2B1TraceScaleTermLedgerRows.restrictedCCM25CutoffMatchesScopedFormulaAt
      (A :=
        (CC20Concrete.TraceScale.normalizedLegalSquareTraceScaleToCC20TraceModel
          pkg.s2b1NormalizedSeed).archimedeanSymbols)
      (W := pkg.toWeilFormSymbols)
