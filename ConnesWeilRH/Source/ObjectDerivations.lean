...
theorem ccm24_common_support_transported
    (pkg : SourceObjectPackage) :
    pkg.ccm24.semilocalSymbols.supportTransported
      pkg.ccm24.semilocalSymbols.sourceTest pkg.ccm24.sourceSupportWindow :=
...
by
  change
    SemilocalModelSymbols.CanonicalSemilocalModelStatement
      pkg.ccm24.semilocalSymbols
  exact pkg.ccm24.sourceModel.canonicalSemilocalModel
...
by
  ...
  exact
    ⟨SemilocalModelSymbols.supportTransported_of_supportInWindow
        hSupport,
      SemilocalModelSymbols.convolutionSupportTransported_of_fourierSupportInWindow
        hFourierSupport⟩
...
by
  change
    SemilocalModelSymbols.BoundedComparisonStatement
      pkg.ccm24.semilocalSymbols
  exact pkg.ccm24.sourceModel.boundedComparison
...
by
  change
    SemilocalModelSymbols.SoninComparisonStatement
      pkg.ccm24.semilocalSymbols
  exact pkg.ccm24.sourceModel.soninComparison
...
theorem provesFinitePrimePointwiseTermStatement
  ...
  fun f g =>
    (provesFinitePrimeNormalizationStatement pkg f g).finitePrimeTermNormalization
