...
2026-09-06 ConnesWeilRH/Dev/C1BombieriP2Bridge.lean + Audit : formally refuted `BombieriQuadraticP2BridgeData` on any healthy detector, since finite H positivity gives `qw ≥ 0` while detector data gives `qw < 0`; focused rebuild 3665 jobs green, standard axioms only, zero sorryAx. The direct quadratic socket is now a NO-GO guard, not an active P2 producer.
