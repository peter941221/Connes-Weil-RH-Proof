...
- Committed frontier `7353968`: the Bombieri Lemma-10 DETECTOR chain is
  landed through slice 12b - section-7 readback + (7.1) symmetry + Lemma-10
  ...
  (QForm), and the boundary bridge `sum gamma_i (gamma_i - gamma_j)
